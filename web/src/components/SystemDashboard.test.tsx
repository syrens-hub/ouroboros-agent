  ...
  beforeEach(() => {
    ...
    mockFetch.mockImplementation(async (path: string) => {
      ...
      if (path === '/api/monitoring/status') {
        return { json: async () => ({ data: { eventBus: { running: true, queueSize: 0, pendingDeadLetters: 0 }, safety: { lockHeld: false, frozen: false, freezeRemainingHours: 0, budget: { withinBudget: true } }, approvals: { pendingCount: 0 }, evolutionVersions: { totalVersions: 0 }, testRuns: {}, evolutionMetrics: { totalEvolutions: 0, successRate: 100, rollbackRate: 0 } } }) }
      }
      return { json: async () => ({}) }
    })
  })
